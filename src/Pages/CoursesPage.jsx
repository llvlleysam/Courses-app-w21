import { Box, Button, Grid, Modal, Pagination, Paper, Stack, styled, Table, TableBody, TableContainer, TableHead, TableRow, TextField, Toolbar, Typography } from "@mui/material";
  ...
  return (
      ...
      {Token ? <div style={{display:"flex",flexDirection:"column", justifyContent:"center" , alignItems:"center", padding:20}}>
        <Toolbar/>
            ...
            <Typography fontSize={20} fontWeight={"bold"} mb={2} style={{display:"flex",justifyContent:"center" ,alignItems:"center"}}>
               <EditNoteIcon color="error"/><span style={{color:"red" , fontWeight:"bold"}}>"{editVal?.teacher}"</span> 
            </Typography>
            <Stack
              component={"form"}
